...
@RestController
@RequestMapping("/auth")
@Tag(name = "Autenticación", description = "Endpoint didáctico para emitir tokens JWT (RS256)")
public class AuthController {
    ...
    @Operation(summary = "Iniciar sesión y obtener un access token JWT",
            description = "Valida las credenciales y emite un JWT firmado con RS256. "
                    + "El claim 'scope' del token depende del usuario autenticado "
                    + "(student -> blueprints.read; assistant -> blueprints.read blueprints.write).")
